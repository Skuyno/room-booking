...
type Booking struct {
	...
	// EndAt Время окончания забронированного слота в UTC.
	EndAt  time.Time          `json:"endAt"`
	Id     openapi_types.UUID `json:"id"`
	RoomId openapi_types.UUID `json:"roomId"`

	// StartAt Время начала забронированного слота в UTC.
...
type PostBookingsCreateJSONBody struct {
	...
	// StartAt Время начала желаемого слота в UTC. Должно быть кратно 30 минутам и попадать в активное расписание комнаты.
	StartAt time.Time `json:"startAt"`
}
